...
- Remaining to improve toward "exact": swap in the real GOCO5S GGM disturbance (manual ICGEM); add the CRUST1.0 sediment correction (verify reader); calibrate z_ref/Δρ/μ with step 15; refine resolution; constrain/clip oceanic artefacts.
