...
8. **`scatter_vs_seismic.png`** — Depth–depth comparison of estimated vs seismic Moho at the 105 stations for this study, CRUST1.0 and GEMMA (1:1 line). Solid line = OLS fit to this study (slope 0.20); large circles = binned means (±1σ): the model tracks the mean trend but compresses amplitude (a resolution effect). GEMMA lies systematically below the line.
