...
6. **`hyperparameters.png`** — Hyperparameter diagnostics: μ hold-out cross-validation curve and the (z_ref, Δρ) validation-MSE surface (minimum at μ=10⁻¹⁰, z_ref=35 km, Δρ=400 kg m⁻³).
