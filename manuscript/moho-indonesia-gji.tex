...
thickest, while still tracking the mean trend (binned-mean $r=0.94$). The
...
\begin{figure}
\centering\includegraphics[width=\columnwidth]{scatter_vs_seismic.png}
\caption{Depth--depth comparison of estimated against seismic Moho at the 105 RF
stations for this study, {CRUST1.0} and {GEMMA} (dashed $1{:}1$ line). The solid
line is the ordinary-least-squares fit to this study (slope $0.20$) and the large
circles are binned means ($\pm1\sigma$): the model tracks the mean trend but
compresses the amplitude, a resolution effect of the smooth satellite gravity.
This study and {CRUST1.0} scatter about the line; {GEMMA} lies systematically below
it (too shallow). Correlations are in the legend and Table~\ref{tab:compare}.}
\label{fig:scatter}
\end{figure}
