...
stations within $\pm5$ and $\pm10$~km. The modest correlation ($r=0.28$) reflects
the narrow 20--40~km range and clustering of the RF depths. Refining the grid to
...
CRUST1.0 and GEMMA (dashed 1:1 line). GEMMA lies systematically below the line.}
\label{fig:scatter}
\end{figure}
