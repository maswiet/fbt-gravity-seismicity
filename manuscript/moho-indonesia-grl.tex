...
deviation bands. (a) This study, (b) CRUST1.0 and (c) GEMMA versus the 105 seismic
Moho depths; (d) GEMMA versus CRUST1.0 over the model grid ($N=817$). Inset:
bias, RMS, per cent within $\pm6$/$\pm12$~km and slope. This study (slope 0.20) and
CRUST1.0 (slope 0.23) show the same amplitude compression, whereas GEMMA (slope
0.08) is systematically shallow.}
\label{fig:scatter}
\end{figure}
