...
grid-to-grid AusMoho comparison (below), which matches like with like, is a fairer
test and yields $r=0.86$. Refining the grid to
...
it is deeper than GEMMA almost everywhere.
...
\begin{figure}
\centering\includegraphics[width=0.8\textwidth]{../figures/moho/scatter_vs_seismic.png}
\caption{Estimated versus seismic Moho depth at the 105 stations for this study,
CRUST1.0 and GEMMA (dashed 1:1 line). The solid line is the ordinary-least-squares
fit to this study (slope 0.20) and the large circles are binned means ($\pm1\sigma$):
the model tracks the trend but compresses the amplitude, a resolution effect of the
smooth satellite gravity. GEMMA lies systematically below the line.}
\label{fig:scatter}
\end{figure}
